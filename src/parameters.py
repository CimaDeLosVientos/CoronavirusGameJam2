...
# Locations buttons
LOCATION_BUTTON_EMAIL = (WIDTH / 3, HEIGHT / 3)  # 720
LOCATION_BUTTON_REVIEW = (WIDTH / 3 * 2, HEIGHT / 3)  # 720
LOCATION_BUTTON_BOOKING = (WIDTH / 3, HEIGHT / 3 * 2)  # 720
LOCATION_BUTTON_UPGRADES = (WIDTH / 3 * 2, HEIGHT / 3 * 2)  # 720
